...
#define EWDmaxWifiSendBufSize 8 //how many bytes will your outgoing message be? (boolean=1,byte=1,int=4,float=4) (comment this line to use the default of 32)
#define EWDmaxWifiRecvBufSize 8 //how many bytes will your incoming message be? (boolean=1,byte=1,int=4,float=4) (comment this line to use the default of 32)
...
void loop()
{
    ...
    EWD::notTimedOut(); //if millisSinceMessage<signalLossTimeout, use to disable your robot if it loses connection
    EWD::newData(); //new data was recieved this loop
}
